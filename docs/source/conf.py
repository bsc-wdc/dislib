...
# -*- coding: utf-8 -*-
#
# dislib documentation build configuration file, created by
...
man_pages = [
    (master_doc, 'dislib', 'dislib Documentation',
     [author], 1)
]
...
def linkcode_resolve(domain, info):
    ...
    return "http://github.com/bsc-wdc/dislib/blob/master/dislib/%s%s%s" \
           % (modname.replace(".", "/"), fullname.replace(".", "/"), linespec)
...
texinfo_documents = [
    (master_doc, 'dislib', 'dislib Documentation',
     author, 'dislib', 'One line description of project.',
     'Miscellaneous'),
]
