...
ENV LC_ALL=C.UTF-8
RUN apt-get update && apt-get install -y libeigen3-dev=3.4.0 && \
    apt-get install -y protobuf=3.11.4 && \
    apt-get install -y libprotobuf=3.11.4 && \
    apt-get install -y zlib=1.2.11
