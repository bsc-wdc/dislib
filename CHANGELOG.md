...
- Updated Read the Docs build environment: bumped Python to 3.10 on ubuntu-22.04, and updated documentation dependencies (`scikit-learn`, `scipy`, `numpy`, `numpydoc`, `myst-parser`, `pydata-sphinx-theme`)
...
<!-- [Unreleased]: https://github.com/bsc-wdc/dislib/compare/v1.0.1...HEAD -->
[1.0.1]: https://github.com/bsc-wdc/dislib/compare/v1.0.0...v1.0.1
[1.0.0]: https://github.com/bsc-wdc/dislib/compare/v0.9.0...v1.0.0
[0.9.0]: https://github.com/bsc-wdc/dislib/compare/v0.8.0...v0.9.0
[0.8.0]: https://github.com/bsc-wdc/dislib/compare/v0.7.0...v0.8.0
[0.7.0]: https://github.com/bsc-wdc/dislib/compare/v0.6.0...v0.7.0
