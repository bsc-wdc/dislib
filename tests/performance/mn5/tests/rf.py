...
def main():
    x_kdd = ds.load_txt_file(
        ...
        "/gpfs/projects/bsc19/MN4/bsc19/COMPSs_DATASETS/dislib/kdd99/train.csv",
    ...
    x_mn, y_mn = ds.load_svmlight_file(
        "/gpfs/projects/bsc19/MN4/bsc19/COMPSs_DATASETS/dislib/mnist/train.scaled",#"/gpfs/projects/bsc19/COMPSs_DATASETS/dislib/mnist/train.scaled",
