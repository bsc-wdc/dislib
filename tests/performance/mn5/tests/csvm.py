...
def main():
    x_kdd = ds.load_txt_file(
        "/gpfs/projects/bsc19/MN4/bsc19/COMPSs_DATASETS/dislib/kdd99/train.csv",#"/gpfs/projects/bsc19/COMPSs_DATASETS/dislib/kdd99/train.csv",
    ...
    x_ij, y_ij = ds.load_svmlight_file(
        "/gpfs/proejcts/bsc19/MN4/bsc19/COMPSs_DATASETS/dislib/ijcnn1/train",#"/gpfs/projects/bsc19/COMPSs_DATASETS/dislib/ijcnn1/train",
