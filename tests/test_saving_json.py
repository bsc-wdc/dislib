...
class JSONSavingTest(unittest.TestCase):
    ...
    def test_saving_gm(self):
        file_ = "tests/files/libsvm/2"
        filepath = os.path.join(DIRPATH, "gm.json")
    ...
    def test_saving_csvm(self):
        ...
        filepath = os.path.join(DIRPATH, "csvm.json")
    ...
    def test_saving_rf_class(self):
        filepath = os.path.join(DIRPATH, "rf_class.json")
    ...
    def test_saving_rf_regr(self):
        filepath = os.path.join(DIRPATH, "rf_regr.json")
    ...
    def test_saving_lasso(self):
        filepath = os.path.join(DIRPATH, "lasso.json")
        np.random.seed(42)
    ...
    def test_saving_linear(self):
        filepath = os.path.join(DIRPATH, "linear_regression.json")
    ...
    def test_saving_als(self):
        filepath = os.path.join(DIRPATH, "als.json")
