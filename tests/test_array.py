...
class DataLoadingTest(DislibTestCase):
...
class LoadHStackNpyFilesTest(DislibTestCase):
...
class SaveTxtTest(DislibTestCase):
...
class ArrayTest(DislibTestCase):
