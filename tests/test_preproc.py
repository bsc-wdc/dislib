...
class MinMaxScalerTest(ScalerTest):
    ...
    def test_fit_transform(self):
        ...
        """
        for feature_range in [(0, 1), (-1, 1)]:
            with self.subTest(feature_range=feature_range):
                ...
                self.assertTrue(np.allclose(sc1.data_min_,
                                            sc2.data_min_.collect()))
                self.assertTrue(np.allclose(sc1.data_max_,
                                            sc2.data_max_.collect()))
